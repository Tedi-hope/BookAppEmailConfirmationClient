...
const ShowBook = () => {
  ...
  useEffect(()=>{
    axios
    .get(`https://bookappemailconfirmationserver.vercel.app/books/${id}`)
    .then((response)=>{
    ...
    <div className="p-4">
       <BackButton /> 
        <h1 className="my-4">ShowBook</h1>
         <div className="border border-2 rounded rounded-xl
          p-4">

          {book.image && (
            <div className="w-1/3 pr-4 h-25">
               <img src={book.image} alt={book.title} 
               className="w-1/3 h-25" />
            </div>
          )}
